...
class ProductsController < AuthenticatedController
  ...
  def create
    store_1_access_token = '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'  # mg-test-store-1 access token
    store_2_access_token = 'shpua_1f98de02a4ab5410445773f221c734b5'  # mg-test-store-2 access token

    stores = [
      { domain: 'mg-test-store-1.myshopify.com', access_token: store_1_access_token },
      { domain: 'mg-test-store-2.myshopify.com', access_token: store_2_access_token }
    ]
